...
| 🧭 منابع تکمیلی منتخب | [منابع تکمیلی برنامه‌نویسی فارسی](منابع-تکمیلی/README.md) |
...
- [Pytest و ساختمان داده Python در منابع تکمیلی](منابع-تکمیلی/README.md#python-و-تستنویسی)
...
- [منابع تکمیلی JavaScript، Laravel و React Query](منابع-تکمیلی/README.md#javascript-و-laravel)
...
- [System Design، Refactoring و Design Patterns](منابع-تکمیلی/README.md#مهندسی-نرمافزار-و-طراحی)
- [Docker، LPIC و DevOps](منابع-تکمیلی/README.md#docker-linux-و-devops)
...
- [LLM و منابع تکمیلی هوش مصنوعی](منابع-تکمیلی/README.md#هوش-مصنوعی-و-llm)

## چه چیزهایی در این مخزن پیدا می‌کنید؟

این فهرست برای دانشجوها، برنامه‌نویس‌های تازه‌کار، توسعه‌دهنده‌هایی که می‌خواهند مهارت جدید یاد بگیرند و هر فارسی‌زبانی که دنبال منابع فنی رایگان است ساخته شده است. موضوعات موجود شامل مواردی مانند Python، JavaScript، Java، C/C++، C#، PHP، React، Node.js، Django، Laravel، Git، Linux، الگوریتم، ساختمان داده، شبکه، Docker، DevOps، SQL، System Design، Refactoring، هوش مصنوعی و مهندسی نرم‌افزار است.

## منابع تکمیلی از جامعه‌ی فارسی‌زبان

علاوه بر فهرست اصلی، یک صفحه‌ی [منابع تکمیلی برنامه‌نویسی فارسی](منابع-تکمیلی/README.md) داریم که موارد جدید و غیرتکراری کشف‌شده از پروژه‌های عمومی جامعه را پس از مرور مستقل اضافه می‌کند.

در این فرایند، از پروژه‌هایی مانند `barnamenevisi/free-resources` برای **کشف لینک** استفاده می‌شود، اما توضیحات این مخزن بازنویسی می‌شوند و mirrorهای نامعتبر، Telegram/file-hosting linkها و موارد با وضعیت حقوقی یا رایگان نامشخص وارد نمی‌شوند. provenance دقیق snapshot منبع در همان صفحه ثبت شده است.
...
- **قابل توسعه با منابع جامعه:** discovery از فهرست‌های عمومی انجام می‌شود، اما قبل از ورود به catalog خودمان dedupe و curate می‌شود.
...
Python · JavaScript · Java · C · C++ · C# · PHP · React · Node.js · Django · Laravel · Git · Linux · Docker · DevOps · SQL · System Design · Refactoring · AI · LLM · Algorithms · Data Structures · Software Engineering
