...
# دوره‌های رایگان برنامه‌نویسی فارسی در یوتیوب

این صفحه مجموعه‌ای از **دوره‌های برنامه‌نویسی فارسی در YouTube** است؛ مناسب کسانی که ترجیح می‌دهند Python، JavaScript، Java، C/C++، C#، DevOps، ریاضیات و موضوعات فنی را با ویدیو یاد بگیرند.

> اگر به‌جای playlist دنبال مدرس‌ها و کانال‌های فعال هستید، [کانال‌های یوتیوب فارسی برنامه‌نویسی](../کانال‌های%20یوتیوب/README.md) را ببینید.
...
- [سی](#سی)
- [سی شارپ و دات نت](#سی-شارپ-و-دات-نت)
- [سی++](#سی-پلاس-پلاس)
- [دواپس](#دواپس)
- [ریاضیات](#ریاضیات)
- [لاتک](#لاتک)
...
1. [درک برنامه نویسی با جادی](https://www.youtube.com/watch?v=BR7m_2D_-Uw&list=PL-tKrPVkKKE1Y_o_h2w85dzVdoX5t7SI0)
...
8. [آموزش برنامه نویسی پایتون از مقدماتی تا پیشرفته](https://www.youtube.com/watch?v=_EHmnmGVSDI)
...
2. [آموزش جاوا اسکریپت پروژه محور](https://www.youtube.com/playlist?list=PLAKVGYzakHC25_FHYEPI6ORCEU418kmHc)
3. [آموزش فارسی جاوا اسکریپت مقدماتی تا پیشرفته](https://www.youtube.com/playlist?list=PLfbD3-Ao6cPpt5Y3Nkue_W-DrmdOLOaTH)
...
برای یک موضوع، ابتدا playlist کامل‌تر و مقدماتی‌تر را انتخاب کنید. اگر بعد از چند جلسه سبک مدرس مناسب شما نبود، سراغ گزینه‌ی دیگری بروید؛ جمع کردن playlist بیشتر، جای تمرین و ساخت پروژه را نمی‌گیرد.
